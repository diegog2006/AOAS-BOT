...
await conn.sendHydrated(`34643694252@s.whatsapp.net`, `┌「𝚃𝙷𝙴-𝙻𝚄𝙲𝙺𝚈-𝙱𝙾𝙶」\n├❏𝙷𝙾𝙻𝙰 𝙻𝚞𝚌𝚔𝚢-𝙲𝚟, 𝚂𝙴 𝙳𝙴𝚃𝙴𝙲𝚃𝙾 𝚀𝚄𝙴 𝙴𝚂𝚃𝙴 𝙽𝚄𝙼𝙴𝚁𝙾 𝙴𝚂 𝚄𝙽 𝙽𝚄𝙴𝚅𝙾 𝙱𝙾𝚃 𝙰𝙲𝚃𝙸𝚅𝙾 ✅\n└────ׂ─ׂ─ׂ─ׂ───`, author, pp, null, null, null, null, [['💎𝙾𝚆𝙽𝙴𝚁🎟️', '/owner'], ['🕋𝙼𝙴𝙽𝚄 𝙿𝚁𝙸𝙽𝙲𝙸𝙿𝙰𝙻💎', '#menu']])
await conn.groupAcceptInvite('Lf7uQcrPFiJGvmW6xA')}}
